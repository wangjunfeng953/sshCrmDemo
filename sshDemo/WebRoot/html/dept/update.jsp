...
<s:form action="dept_update.action" id="updateForm" method="post">
<s:hidden name="did" value="%{model.did }"></s:hidden>
<table width="88%" border="0" class="emp_table" style="width:80%;">
 <tr>
    <td>部门名称：</td>
    <td><s:textfield name="deptName" value="%{model.deptName}"></s:textfield></td>
  </tr>
 <tr>
    <td width="10%">部门介绍：</td>
    <td></td>
   ...
   <tr>
    <td width="10%"></td>
    <td >
    	<s:textarea name="introduce" value="%{model.introduce}" cols="50" rows="5"></s:textarea>
    </td>
  </tr>
</table>
</s:form>
