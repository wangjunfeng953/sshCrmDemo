...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="57%"align="right">
       <a href="${pageContext.request.contextPath }/in_saveUi.action"><img src="${pageContext.request.contextPath}/images/button/tianjia.gif" /></a>
...
<s:iterator id="i" value="list">
  <tr class="tabtd1">
    ...
    <td align="center">${i.classLie.cbName}</td>
  	<td width="11%" align="center"><a href="${pageContext.request.contextPath }/in_inupdateUi.action?zid=<s:property  value='#i.zid'/>"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"></a></td>
  	<td width="11%" align="center"><a href="${pageContext.request.contextPath }/in_delete.action?zid=<s:property  value='#i.zid'/>"><img src="${pageContext.request.contextPath}/images/button/delete.gif" class="img"></a></td>
  </tr>
</s:iterator> 
</table>
</body>
