    ...
    <td align="right">
        ...
        <span>
        	<s:if test="creePage!=1">
        		<a href="${pageContext.request.contextPath }/cla_cateAndPage.action?creePage=1">[首页]</a>&nbsp;&nbsp;
            	<a href="${pageContext.request.contextPath }/cla_cateAndPage.action?creePage=<s:property  value='creePage-1'/>">[上一页]</a>&nbsp;&nbsp;
           	</s:if>
           	<s:if test="creePage!=totaPage">
            	<a href="${pageContext.request.contextPath }/cla_cateAndPage.action?creePage=<s:property  value='creePage+1'/>">[下一页]</a>&nbsp;&nbsp;
            	<a href="${pageContext.request.contextPath }/cla_cateAndPage.action?creePage=<s:property  value='totaPage'/>">[尾页]</a>
        	</s:if>
        </span>
    </td>
  </tr>
