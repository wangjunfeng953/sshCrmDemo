...
<s:form id="saveForm" action="cla_update.action" method="post">
<s:hidden name="cid" value="%{model.cid}"></s:hidden>
<table width="88%" border="0" class="emp_table" style="width:80%;">
  <tr>
    <td width="10%">课程类别：</td>
    <td width="20%"><s:textfield name="cateName" value="%{model.cateName}"></s:textfield>   </td>
    <td width="8%">总学时：</td>
    <td width="62%"><s:textfield name="xuetime" value="%{model.xuetime}"/></td>
  </tr>
  <tr>
    <td>课程费用：</td>
    <td><s:textfield name="xuePrice" value="%{model.xuePrice}" /></td>
    <td>课程简介：</td>
    <td><s:textfield name="intrdJie" value="%{model.intrdJie}" /></td>
  </tr>
</table>
</s:form>
</body>
